...
public class ChessBoard
{
	...
	ChessPiece[] map={
			new Rook(true),new Knight(true),null,null,null,null,new Knight(true),new Rook(true),
			...
			new Rook(false),new Knight(false),null,null,null,null,new Knight(false),new Rook(false)
	};
